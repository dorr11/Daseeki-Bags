...
'O ADDON não exibe níveis de item nativamente. Você deve estar usando um plugin de terceiros para isso. Tente atualizar os plugins que está usando, a causa mais comum é estar desatualizado.|n|nObserve que qualquer problema com plugins deve ser relatado aos seus autores.',
