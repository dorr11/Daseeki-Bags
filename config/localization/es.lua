...
L.FAQ = {
  ...
  '¿Cómo hacer que ADDON olvide a un personaje eliminado o renombrado?',
  ...
  'ADDON no muestra nativamente los niveles de los objetos. Debes estar utilizando un complemento de terceros para ello. Intenta actualizar los complementos que estás utilizando; la causa más común es que estén desactualizados.|n|nTen en cuenta que cualquier problema con los complementos debe ser reportado a sus autores.',

  'ADDON está ocultando una de mis bolsas.',
  ...
  '¿Cómo alternar ADDON para el banco, depósito del vacío, etc.?',
  'Ve a ADDON -> Opciones de ventana. Estás buscando las dos opciones en la parte superior del panel. Elige la "Ventana" que deseas alternar y luego haz clic en "Activar esta ventana".'
}
