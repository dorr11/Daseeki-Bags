...
L.FAQ = {
  ...
  'ADDON non mostra nativamente i livelli degli oggetti. Devi usare un componente aggiuntivo di terze parti per questo. Prova ad aggiornare i componenti aggiuntivi: la causa più comune è una versione obsoleta.|n|nEventuali problemi con i componenti aggiuntivi devono essere segnalati ai rispettivi autori.',
