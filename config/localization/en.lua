...
local L = LibStub('AceLocale-3.0'):NewLocale(CONFIG, 'enUS', true)
...
L.MoneyTooltipFaction = 'Show Same Faction Only'
L.MoneyTooltipFactionTip = 'If enabled, the gold tooltip will only show characters belonging to your current faction (Alliance or Horde).'
L.MoneyTooltipMinGold = 'Minimum Gold to Display'
L.MoneyTooltipMinGoldTip = 'Characters holding less gold than this amount will be hidden from the gold tooltip.'
L.Database = 'Database'
L.ActiveProfile = 'Active Profile'
L.NewProfile = 'New Profile'
L.CopyProfile = 'Copy Profile'
L.DeleteProfile = 'Delete Profile'
L.NewProfilePrompt = 'Enter a name for the new profile:'
L.CopyProfilePrompt = 'Enter a name for the copy of "%s":'
L.ConfirmDeleteProfile = 'Delete the profile "%s"? This cannot be undone.'
L.ExportProfile = 'Export Profile'
L.ImportProfile = 'Import Profile'
L.ExportProfilePopup = 'Copy this string and paste it on another account to import this profile:'
L.ImportProfilePopup = 'Paste a profile string exported from another account:'
L.ImportProfileError = 'Profile import failed'
L.CharacterData = 'Character Data'
L.DeleteCharacterData = 'Delete Character Data'
L.ConfirmDeleteCharacter = 'Delete all stored data for %s? This cannot be undone.'
L.ResetDatabase = 'Reset Database'
L.ConfirmResetDatabase = 'This will permanently delete all cached item, currency, bank, and mail data for every character. This cannot be undone. Continue?'

-- item finder
L.FindItem = 'Find Item'
L.FindItemTip = 'Search every stored character for an item, by name.'
L.NoItemsFound = 'No items found'
L.Bags = 'Bags'
L.Bank = 'Bank'
L.Equipped = 'Equipped'
L.Mail = 'Mail'
L.VoidStorage = 'Void Storage'
...
L.LockedTip = 'If enabled, frames cannot be moved or resized.'
...
L.Tooltips = 'Tooltips'
L.OtherAccounts = 'Other Accounts'
L.MeshSync = 'Cross-Account Sync'
L.MeshTokenTip = 'Share gold live across accounts. Both must use the same channel and token. You can reuse an existing addon channel (e.g. ShadowNetwork\'s) to avoid an extra channel slot.|n|nLeave token blank to disable.'
L.MeshTokenSet = 'Set Token'
L.MeshTokenPrompt = 'Enter a shared sync token (same on every account):'
L.MeshTokenActive = 'Token: %s'
L.MeshTokenNone = 'Token: not set'
L.MeshChannelSet = 'Set Channel'
L.MeshChannelPrompt = 'Enter the channel name to use (same on every account):'
L.MeshChannelActive = 'Channel: %s'
L.MeshChannelNone = 'Channel: using default (DBagSync + token)'
...
L.ColorAlpha = 'Background Opacity'
...
L.SlotAlpha = 'Artwork Opacity'
L.SlotBorder = 'Slot Border'
L.SlotBorderColor = 'Item Border Color'
...
L.FAQ = {
  ...
  'ADDON does not natively display item levels. You must be using a third party plugin for this. Try to update the plugins you are using, most common cause is being out of date.|n|nPlease note that any issue with plugins should be reported to their authors.',
