...
L.FAQ = {
  ...
  'ADDON zeigt keine Gegenstandsstufen von Haus aus an. Du musst ein Drittanbieter-Plugin dafür verwenden. Aktualisiere deine Plugins – meist liegt es an einer veralteten Version.|n|nProbleme mit Plugins sollten deren Autoren gemeldet werden.',
