...
L.EnabledTip = 'Если настройка отключена, стандартный интерфейс Blizzard не будет заменён для этого окна.\n\n|cffff1919Потребуется перезагрузка интерфейса.|r'
...
L.FAQ = {
  ...
  'ADDON не отображает уровни предметов по умолчанию. Для этого нужно использовать сторонний плагин. Попробуйте обновить плагины — чаще всего причина в устаревшей версии.|n|nПроблемы с плагинами нужно сообщать их авторам.',
