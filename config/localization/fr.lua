...
L.FAQ = {
  ...
  "ADDON n’affiche pas nativement les niveaux d’objet. Vous devez utiliser un module tiers pour cela. Essayez de mettre à jour vos modules, la cause la plus fréquente est une version obsolète.|n|nVeuillez signaler tout problème de module à leurs auteurs.",
