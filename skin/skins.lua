--[[
	Built-in skins for Daseeki-Bags.
	All Rights Reserved
--]]
...
Addon.Skins.Default = 'Dialog'
Addon.Skins:Register { id = 'DaseekiBags', template = 'NineSliceCodeTemplate', load = apply9S('TooltipDefaultLayout'), centerColor = center9S, borderColor = border9S }
...
Addon.Skins:Register { id = 'Dialog', template = 'DaseekiBagsDialogSkinTemplate', centerColor = center9S, borderColor = border9S, x=-7,y=-7, x1=7,y1=7, margin=4 }
Addon.Skins:Register { id = 'Inset', template = 'DaseekiBagsInsetSkinTemplate', centerColor = center9S, margin=2 }
Addon.Skins:Register { id = 'OnePixel', template = 'DaseekiBagsOnePixelTemplate', centerColor = center9S, borderColor = border9S, margin=3 }

Addon.Skins:Register {
	id = 'Daseekium', template = 'DefaultPanelFlatTemplate', font = GameFontNormalCenter, fontH = GameFontHighlightCenter,
