...
Rules:Register {id = 'all', title = ALL, icon = 'Interface/Addons/Daseeki-Bags/art/achievement-guildperk-mobilebanking', static = true}
...
do
	local classes = {
		['Interface/Addons/Daseeki-Bags/art/achievement_quests_completed_06'] = {'Questitem'},
